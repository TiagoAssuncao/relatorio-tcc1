...
Assim, dessa forma, temos a definição de (artigo 2 - 15) sobre qual é o conceito de
...
O estudo da Social Matching, realizado por (R. Nayak, M. Zhang, and L. Chen),
...
Pressman (2011) traz uma boa definição para processos de software, afirmando que trata-se de um conjunto de metodologias definidas das atividades, ações e tarefas definidas para o desenvolvimento de um software de alta qualidade.
